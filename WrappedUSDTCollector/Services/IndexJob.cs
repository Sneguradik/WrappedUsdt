...
public class IndexJob(IIndexService indexService, IExmoService exmoService, ISyncService syncService, ILogger<IndexJob> logger) : IJob
{
    public async Task Execute(IJobExecutionContext context)
    {
        var startTime = DateTime.UtcNow;
        Task<IEnumerable<Candle>>[] tasks = [ 
